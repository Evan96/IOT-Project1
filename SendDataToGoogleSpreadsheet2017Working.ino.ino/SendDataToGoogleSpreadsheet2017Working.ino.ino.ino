...
const String CLIENT_ID = "632175428012-8k1797i44uc4747q8kr0k7uknfusfi7n.apps.googleusercontent.com";

// the clientSecret found in Google's Developer Console under API Manager > Credentials
const String CLIENT_SECRET = "BOb0M_sThr57zb1SvzXhzJz2";

// returned after running FinalizeOAuth
const String REFRESH_TOKEN = "1/HlZCjfi5_wuxtvItGXQBlIRVujwnxycHOXBxMWRIxT8";
...
String myName = "Evan Mulcahy"; //Enter your name here
...
//unsigned long getSensorReading() {
